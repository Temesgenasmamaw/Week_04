...
class DataPreprocessor:
    ...
    def clean_data(self):
        ...
        self.train_df.drop(columns=['Customers', 'index','PromoInterval'], errors='ignore', inplace=True)

        self.test_df.drop(columns=['Id'], errors='ignore', inplace=True)
        self.test_df.drop(columns=['Customers', 'index','PromoInterval'], errors='ignore', inplace=True)
